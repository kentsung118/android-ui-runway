package com.kent.android.slim.sample.letv.desktopmanager.view;
...
public class BadgeImageView extends ImageView implements Badge {
    ...
    private void init() {
        ...
        mFrameLayoutParams = new FrameLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.CENTER);
        mRelativeLayoutParams = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT,
    ...
    public void setTargetView(View target) {
        ...
        if (target.getParent() instanceof FrameLayout
                || target.getParent() instanceof RelativeLayout) {
            if (getLayoutParams() == null) {
                ...
                this.setLayoutParams(target.getParent() instanceof FrameLayout ? mFrameLayoutParams
                        : mRelativeLayoutParams);
            }
        ...
        if (target instanceof FrameLayout || target instanceof RelativeLayout) {
            if (getLayoutParams() == null) {
                ...
                this.setLayoutParams(
                        target instanceof FrameLayout ? mFrameLayoutParams : mRelativeLayoutParams);
            }
